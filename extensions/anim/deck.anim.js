...
(function($, deck, undefined) {
    ...
    // DT10 : allow colours within SVG to be animated by hooking jquery color plugin
    jQuery.Color.hook("fill stroke background");
        ...
        classical(o.selectors.animAttribute, {
            ...
            undo: function(c) {
                ...
                for (i in c.previousElement) { // use the saved list of elements and values
                    ...
                    // DT10 - This fails on backwards stepping for animating of
                    // font-size within a SVG. The default handling seems to work fine.
